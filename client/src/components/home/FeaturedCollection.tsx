      ...
      <Container>
        ...
        >
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h3 className="font-playfair text-3xl mb-6">URBANE EDITION</h3>
            ...
            <Link 
              to="/collection" 
              className="inline-block uppercase text-sm font-medium tracking-wider border-b-2 border-gold hover:text-gold transition-colors"
            >
              DISCOVER COLLECTION
            </Link>
          </motion.div>
          <motion.div 
            className="order-1 lg:order-2 grid grid-cols-3 gap-4"
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
          >
            <h3 className="font-playfair text-3xl mb-6">RANI COLLECTION</h3>
            <p className="text-gray-600 mb-6">
